...
describe('NamespaceManager', () => {
  ...
  test('should return search namespaces for agent (private + shared)', () => {
    const ns = new NamespaceManager(baseUserId);
    const userIds = ns.getSearchUserIds('myka');
  ...
  test('should return base userId for search when no agentId', () => {
    const ns = new NamespaceManager(baseUserId);
    const userIds = ns.getSearchUserIds(undefined);
...
describe('buildSearchOptions with agentIsolation', () => {
  ...
  test('with agentIsolation + agentId, should return private + shared options', () => {
    const cfg = { ...baseCfg, agentIsolation: true };
